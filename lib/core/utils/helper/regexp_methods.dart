class RegExpManager {
  ...
  static RegExp syntaxPatterns = RegExp(
    ...
    r"'[^']*'"
    r')'
    r'|(?<keyword>\b(var|final|const|void|class|async|await|static|extends|with|return|true|false|null|if|else|for|while|do|switch|case|break|continue|try|catch|throw|import|export|typedef|extension|on|set|get|dynamic|required|super|factory)\b)'
